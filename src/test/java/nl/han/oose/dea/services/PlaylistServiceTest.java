...
public class PlaylistServiceTest {
    ...
    public void addPlaylistReturnsAPlaylist() {
        ...
        when(userAuthFixture.checkIfTokenExists(TOKEN)).thenReturn(true);
        when(userDAOFixture.getUserId(TOKEN)).thenReturn(USER_ID);
        when(playlistDAOFixture.addPlaylist(USER_ID, playlistDTO.getName())).thenReturn(true);
        when(playlistDAOFixture.getAllPlaylists(USER_ID)).thenReturn(playlist);
    ...
    public void deletePlaylistReturnsAPlaylist() {
        ...
        when(userAuthFixture.checkIfTokenExists(TOKEN)).thenReturn(true);
        when(userDAOFixture.getUserId(TOKEN)).thenReturn(USER_ID);
        when(playlistDAOFixture.deletePlaylist(PLAYLIST_ID)).thenReturn(true);
        when(playlistDAOFixture.getAllPlaylists(USER_ID)).thenReturn(playlist);
    ...
    public void updatePlaylistReturnsAPlaylist() {
        ...
        when(userAuthFixture.checkIfTokenExists(TOKEN)).thenReturn(true);
        when(userDAOFixture.getUserId(TOKEN)).thenReturn(USER_ID);
        when(playlistDAOFixture.updatePlaylist(PLAYLIST_ID, playlistName)).thenReturn(true);
        when(playlistDAOFixture.getAllPlaylists(USER_ID)).thenReturn(playlist);
    ...
    public void getAllTracksFromPlaylistReturnsTracks() {
        ...
        when(userAuthFixture.checkIfTokenExists(TOKEN)).thenReturn(true);
        when(playlistDAOFixture.getAllTracksById(PLAYLIST_ID)).thenReturn(tracks);
    ...
    public void deleteTrackFromPlaylistReturnsTracks() {
        ...
        when(userAuthFixture.checkIfTokenExists(TOKEN)).thenReturn(true);
        when(playlistDAOFixture.deleteTrackFromPlaylist(PLAYLIST_ID, trackId)).thenReturn(true);
        when(playlistDAOFixture.getAllTracksById(PLAYLIST_ID)).thenReturn(tracks);
    ...
    public void addTrackToPlaylistReturnsTracks() {
        ...
        when(userAuthFixture.checkIfTokenExists(TOKEN)).thenReturn(true);
        when(playlistDAOFixture.addTrackToPlaylist(PLAYLIST_ID, track)).thenReturn(true);
        when(playlistDAOFixture.getAllTracksById(PLAYLIST_ID)).thenReturn(tracks);
